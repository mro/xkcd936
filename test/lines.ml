...
let () =
  ...
  assert (6 = l);
  assert (1 = Lines.forw bs l 0);
  assert (1 = Lines.forw bs l 1);
  assert (1 = Lines.forw bs l 2);
  assert (4 = Lines.forw bs l 3);
  assert (4 = Lines.forw bs l 4);
  assert (4 = Lines.forw bs l 5)
